...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.getSection().put(SectionType.OBJECTIVE, new TextAbstractSection("Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям"));
        resume.getSection().put(SectionType.PERSONAL, new TextAbstractSection("Аналитический склад ума, сильная логика, креативность, инициативность. Пурист кода и архитектуры."));
        ...
        resume.getSection().put(SectionType.ACHIEVEMENT, new ListAbstractSection(achievement));
        ...
        resume.getSection().put(SectionType.QUALIFICATIONS, new ListAbstractSection(qualifications));
        ...
        resume.getSection().put(SectionType.EXPERIENCE, new InstitutionAbstractSection(institutions));
        ...
        resume.getSection().put(SectionType.EDUCATION, new InstitutionAbstractSection(institutionsEducation));
