...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.setSection(SectionType.EXPERIENCE, new InstitutionSection(institutions));
        ...
        resume.setSection(SectionType.EDUCATION, new InstitutionSection(institutionsEducation));
